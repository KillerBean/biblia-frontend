...
void main() {
  group('Verse', () {
    ...
    test(
        'fromMap should parse correctly with nested book structure (API improvement)',
        () {
      final map = {
        'id': 2,
        'chapter': 2,
      ...
      expect(verse.bookName,
          'Exodus'); // Should be extracted from nested book.name
    });
    ...
    test(
        'fromMap should throw or fail gracefully if bookId is missing in both places',
        () {
      final map = {
        'id': 4,
        'chapter': 4,
